...
def main():
    ...
    frame_nx5 = np.array(
    [
        [1.2863788950782504, 0.36128353529627877, -0.6064357684295373, -0.06492302387936785, 1.0],     # robot
        [5.155636210103314, -0.036081292907845376, -0.48114876064206347, 0.2534955817390767, 0.0],    # pedestrian 1
        [2.8962110279315154, -0.6049936251232024, -0.02351811048844317, -1.184045972900975, 0.0],   # pedestrian 2
    ],
    dtype=np.float32,
)
